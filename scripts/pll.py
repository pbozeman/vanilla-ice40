...
def main():
    ...
    parser.add_argument(
        "desired_output_clock", type=float, help="Desired output clock frequency in MHz"
    )
    ...
    best_params, expected_output_clock = calculate_pll_parameters(
        input_clock, desired_output_clock
    )
